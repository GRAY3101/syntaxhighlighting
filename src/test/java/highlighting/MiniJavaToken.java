  ...
  void TokenAmAnfang() {
    ...
    void KeywordInKommentarWirdIgnoriert() {
        ...
        if (keywordMatcher.find()) {
            ...
            assertTrue(keywordStart >= commentStart && keywordStart < commentEnd,
    ...
    void KommentarZeichenInEinemString() {
        ...
        assertEquals(text, stringMatcher.group(), "Der Match muss den kompletten String inklusive Anführungszeichen umfassen.");
        ...
        if (lineCommentMatcher.find()) {
            assertTrue(lineCommentMatcher.start() > stringMatcher.start() && lineCommentMatcher.end() < stringMatcher.end(),
                "Der Zeilenkommentar-Regex hat fälschlicherweise Text innerhalb des Strings getroffen.");
        }

        if (blockCommentMatcher.find()) {
            assertTrue(blockCommentMatcher.start() > stringMatcher.start() && blockCommentMatcher.end() < stringMatcher.end(),
